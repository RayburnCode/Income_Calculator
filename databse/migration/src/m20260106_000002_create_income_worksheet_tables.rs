        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(Alias::new("creditor_name")).string().not_null())
                    .col(ColumnDef::new(Alias::new("account_number")).string().null())
                    .col(ColumnDef::new(Alias::new("monthly_payment")).decimal_len(15, 2).not_null())
                    .col(ColumnDef::new(Alias::new("unpaid_balance")).decimal_len(15, 2).not_null())
                    .col(ColumnDef::new(Alias::new("to_be_paid_off")).boolean().not_null().default(false))
                    .col(ColumnDef::new(Alias::new("will_be_paid_off")).boolean().not_null().default(false))
