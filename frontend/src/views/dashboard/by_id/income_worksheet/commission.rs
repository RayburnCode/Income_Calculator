			...
			div { class: "bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-xl shadow-md border-2 border-green-200",
				...
				div { class: "space-y-6",
					...
					div { class: "grid grid-cols-12 gap-4 items-end",
						...
						div { class: "col-span-1 text-center text-gray-500 font-semibold",
							"minus"
						}
						div { class: "col-span-3",
							Input {
				...
				div { class: "space-y-4",
					div { class: "grid grid-cols-2 gap-4",
						div { class: "flex items-center justify-between p-4 bg-blue-100 rounded-lg",
							...
							span { class: "font-bold text-blue-800", "{format_money(ytd_avg_net())}" }
						}
						div {
							class: "flex items-center justify-between p-4 bg-blue-100 rounded-lg",
							span { class: "font-semibold", "2106 YTD Expense Estimate" }
							span { class: "font-bold text-blue-800", "FALSE" } // Placeholder
						}
					}
					div { class: "grid grid-cols-2 gap-4",
						div { class: "flex items-center justify-between p-4 bg-blue-100 rounded-lg",
							span { class: "font-semibold", "YTD + 1 year using Net Income" }
							span { class: "font-bold text-blue-800", "{format_money(ytd_plus_1_year())}" }
						}
						div {
							class: "flex items-center justify-between p-4 bg-blue-100 rounded-lg",
					...
					div { class: "grid grid-cols-3 gap-4",
						div { class: "flex items-center justify-between p-4 bg-blue-100 rounded-lg",
							...
							span { class: "font-bold text-blue-800", "{format_money(ytd_plus_2_year())}" }
						}
						div { class: "p-4 bg-blue-100 rounded-lg",
							div { class: "font-semibold mb-2", "Commission" }
							div { class: "font-bold text-blue-800", "$ -" } // Placeholder
						}
						div { class: "p-4 bg-blue-100 rounded-lg",
