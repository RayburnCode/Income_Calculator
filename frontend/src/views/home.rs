        ...
        div { class: "min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100",
            ...
            div { class: "container mx-auto px-6 py-16",
                div { class: "text-center",
                    h1 { class: "text-5xl font-bold text-gray-900 mb-6", "Income Calculator" }
                    ...
                    div { class: "flex flex-col sm:flex-row gap-4 justify-center",
                        ...
                        button {
                            class: "bg-white hover:bg-gray-50 text-gray-800 font-semibold py-3 px-8 rounded-lg border border-gray-300 transition duration-300 shadow-lg hover:shadow-xl",
                            onclick: |_| {},
                            "Learn More"
                        }
                    }
            ...
            div { class: "container mx-auto px-6 py-16",
                div { class: "text-center mb-12",
                    h2 { class: "text-3xl font-bold text-gray-900 mb-4", "Powerful Financial Tools" }
                ...
                div { class: "grid md:grid-cols-3 gap-8",
                    ...
                    div { class: "bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition duration-300",
                        ...
                        h3 { class: "text-xl font-semibold text-gray-900 mb-2", "Mortgage Calculator" }
                    ...
                    div { class: "bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition duration-300",
                        ...
                        h3 { class: "text-xl font-semibold text-gray-900 mb-2", "Income Analysis" }
                        p { class: "text-gray-600",
                    ...
                    div { class: "bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition duration-300",
                        ...
                        h3 { class: "text-xl font-semibold text-gray-900 mb-2", "Debt-to-Income Ratio" }
                        p { class: "text-gray-600",
                ...
                div { class: "container mx-auto px-6",
                    div { class: "grid md:grid-cols-4 gap-8 text-center",
                        div {
                            ...
                            p { class: "text-gray-600", "Calculations Made" }
                        }
                        div {
                            div { class: "text-3xl font-bold text-green-600 mb-2", "95%" }
                            p { class: "text-gray-600", "Accuracy Rate" }
                        }
                        div {
                            div { class: "text-3xl font-bold text-purple-600 mb-2",
                                "24/7"
                            }
                            p { class: "text-gray-600", "Available" }
                        }
                        div {
                            div { class: "text-3xl font-bold text-orange-600 mb-2",
                                "Free"
                            }
                            p { class: "text-gray-600", "No Hidden Fees" }
                        }
                    }
                }
            }
            ...
            div { class: "bg-blue-600 py-16",
                div { class: "container mx-auto px-6 text-center",
                    ...
                    Link {
                        to: Route::MainDashboard {},
                        class: "bg-white hover:bg-gray-100 text-blue-600 font-semibold py-3 px-8 rounded-lg transition duration-300 shadow-lg hover:shadow-xl",
                        "Start Calculating"
                    }
                }
            }
